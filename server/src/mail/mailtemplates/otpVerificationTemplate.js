const otpVerificationTemplate = (otp, userName = "User") => {
    return `
    <!DOCTYPE html>
    <html lang="en">
    <head>
        ...
        <title>Email Verification - GRAMS</title>
    </head>
                    ...
                    <table role="presentation" style="width: 600px; border-collapse: collapse; background-color: #ffffff; border-radius: 16px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
                        ...
                        <tr>
                            <td style="padding: 40px;">
                                <h2 style="color: #1f2937; font-size: 24px; margin: 0 0 16px 0; text-align: center;">Email Verification</h2>
                                ...
                                <!-- OTP Box -->
                                <div style="background: linear-gradient(135deg, #f0fdf4 0%, #dcfce7 100%); border: 2px solid #16a34a; border-radius: 12px; padding: 24px; text-align: center; margin: 24px 0;">
                                    ...
                                    <h1 style="color: #16a34a; font-size: 42px; margin: 0; letter-spacing: 12px; font-weight: 700;">${otp}</h1>
                                </div>
                                ...
                                <div style="background-color: #fef3c7; border-left: 4px solid #f59e0b; padding: 16px; border-radius: 0 8px 8px 0; margin: 24px 0;">
                                    <p style="color: #92400e; font-size: 14px; margin: 0;">
                                        <strong>⚠️ Security Notice:</strong> Never share this OTP with anyone. GRAMS team will never ask for your OTP.
                                    </p>
                                </div>
                            </td>
                        </tr>
