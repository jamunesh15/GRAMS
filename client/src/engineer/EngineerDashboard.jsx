  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-50/30 mt-16 flex">
      ...
      <div className={`flex-1 transition-all duration-200 ${isSidebarOpen ? 'lg:blur-none blur-sm' : ''}`}>
        {/* Mobile Hamburger Button - Top position */}
        <button
          onClick={() => setIsSidebarOpen(!isSidebarOpen)}
          className="lg:hidden fixed top-[72px] left-4 w-12 h-12 bg-gradient-to-r from-blue-500 to-indigo-600 text-white rounded-lg shadow-lg flex items-center justify-center hover:shadow-xl transition-all z-[999]"
        >
          {isSidebarOpen ? (
